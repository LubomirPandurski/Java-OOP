...
public class ControllerImpl implements Controller {
    ...
    public String addAnimal(String areaName, String animalType, String animalName, String kind, double price) {
        ...
        boolean areasAndAnimalAreLand = areaType.equals("LandArea") && animalType.equals("TerrestrialAnimal");
        boolean areasAndAnimalAreWater = areaType.equals("WaterArea") && animalType.equals("AquaticAnimal");
        if(areasAndAnimalAreLand || areasAndAnimalAreWater){
    ...
    public String calculateKg(String areaName) {
        ...
        double kilograms = animals.stream()
